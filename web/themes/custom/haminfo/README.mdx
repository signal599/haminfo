...
haminfo theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of haminfo theme and run the following commands:
`nvm use`
...
`drush en haminfo -y`
`drush config-set system.theme default haminfo -y`
